...
func ReadPSDTemplate(filepath string) ([]byte, error) {
	data, err := FindPSDHeader(filepath)
	if err != nil {
		fmt.Println("Erro ao tentar ler header do PSD", err)
		return nil, err
	}
